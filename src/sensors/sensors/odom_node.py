...
class OdomNode(Node):
    ...
    def __init__(self):
        ...
        laser_tf_msg.transform.translation.y = 0.0
        laser_tf_msg.transform.translation.z = 0.0

        # orientation of straight forward
        laser_tf_msg.transform.rotation.x = 0.0
        laser_tf_msg.transform.rotation.y = 0.0
